...
const PLANS: Plan[] = [
  {
    ...
    icon: Sparkles,
    featuresAr: ["حتى 3 وحدات", "مباني غير محدودة", "تقارير أساسية", "دعم بالبريد"],
    featuresEn: ["Up to 3 units", "Unlimited buildings", "Basic reports", "Email support"],
  },
  {
    id: "personal",
    nameAr: "شخصي",
    ...
    icon: Zap,
    featuresAr: ["حتى 10 وحدات", "مباني غير محدودة", "تقارير متقدمة", "تذكيرات تلقائية", "تصدير PDF", "+ وحدات إضافية بـ $0.99/شهر"],
    featuresEn: ["Up to 10 units", "Unlimited buildings", "Advanced reports", "Auto reminders", "PDF export", "Extra units at $0.99/mo"],
  },
  {
    id: "pro",
    nameAr: "احترافي",
  ...
  },
  {
    ...
    taglineAr: "للشركات والوكلاء",
    taglineEn: "For agencies & enterprises",
    icon: Building2,
    featuresAr: ["حتى 75 وحدة", "مباني غير محدودة", "علامة تجارية مخصصة", "API مفتوح", "تكامل ZATCA", "+ وحدات إضافية بـ $0.49/شهر"],
    featuresEn: ["Up to 75 units", "Unlimited buildings", "Custom branding", "Open API", "ZATCA integration", "Extra units at $0.49/mo"],
  },
];
