...
const dict: Dict = {
  ...
  tagline: { ar: "إدارة عقاراتك بذكاء", en: "Smart property management", ur: "ذہین جائیداد کا انتظام", zh: "智能物业管理", hi: "स्मार्ट संपत्ति प्रबंधन", bn: "স্মার্ট সম্পত্তি ব্যবস্থাপনা", fr: "Gestion immobilière intelligente", es: "Gestión inteligente de propiedades", tr: "Akıllı mülk yönetimi", ru: "Умное управление недвижимостью", de: "Intelligente Immobilienverwaltung", pt: "Gestão inteligente de imóveis", it: "Gestione immobiliare intelligente", ja: "スマート不動産管理", ko: "스마트 부동산 관리" },
