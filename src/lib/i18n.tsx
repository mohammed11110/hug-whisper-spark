...
const dict: Dict = {
  ...
  continue_with_apple: { ar: "المتابعة بحساب Apple", en: "Continue with Apple", fr: "Continuer avec Apple", es: "Continuar con Apple", tr: "Apple ile devam et", de: "Mit Apple fortfahren", ur: "Apple کے ساتھ جاری رکھیں", fa: "ادامه با Apple", he: "המשך עם Apple" },
  continue_with_google: { ar: "المتابعة بحساب Google", en: "Continue with Google", fr: "Continuer avec Google", es: "Continuar con Google", tr: "Google ile devam et", de: "Mit Google fortfahren", ur: "Google کے ساتھ جاری رکھیں", fa: "ادامه با Google", he: "המשך עם Google" },
  continue_with_email: { ar: "المتابعة بالبريد الإلكتروني", en: "Continue with email", fr: "Continuer par e-mail", es: "Continuar con correo", tr: "E-posta ile devam et", de: "Mit E-Mail fortfahren", ur: "ای میل کے ساتھ جاری رکھیں", fa: "ادامه با ایمیل", he: "המשך עם דוא״ל" },
  auth_or_divider: { ar: "أو", en: "or", fr: "ou", es: "o", tr: "veya", de: "oder", ur: "یا", fa: "یا", he: "או" },
  auth_privacy_note: { ar: "كلمات المرور لا تُحفظ في أملاكي. Apple يتيح إخفاء بريدك الإلكتروني.", en: "Passwords aren't stored by Amlaki. Apple lets you hide your email." },
