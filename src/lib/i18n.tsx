...
const dict: Dict = {
  ...
  tagline: { ar: "إدارة عقاراتك بذكاء وأناقة", en: "Manage your properties with elegance and intelligence", ur: "ذہانت اور نفاست کے ساتھ جائیداد کا انتظام", zh: "以优雅与智慧管理您的房产", hi: "अपनी संपत्तियों का स्मार्ट और सुरुचिपूर्ण प्रबंधन", bn: "মার্জিত ও বুদ্ধিমত্তার সাথে সম্পত্তি ব্যবস্থাপনা", fr: "Gérez vos biens avec élégance et intelligence", es: "Gestione sus propiedades con elegancia e inteligencia", tr: "Mülklerinizi zarafet ve zekâ ile yönetin", ru: "Управляйте недвижимостью с элегантностью и умом", de: "Verwalten Sie Ihre Immobilien mit Eleganz und Intelligenz", pt: "Faça a gestão dos seus imóveis com elegância e inteligência", it: "Gestisci i tuoi immobili con eleganza e intelligenza", ja: "優雅さと知性で不動産を管理", ko: "우아함과 지성으로 부동산을 관리하세요" },
