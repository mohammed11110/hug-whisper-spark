...
// On native iOS, Apple uses the app's Bundle ID directly (NOT a Services ID).
// Services IDs are only for web-based Sign in with Apple flows.
export const APPLE_SERVICES_ID = "com.mohammeddahaish.amlaki";
// =========================================================
