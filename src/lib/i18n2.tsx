...
type Key =
  ...
  | "refund_amount" | "outstanding_at_end" | "settle_arrears" | "carry_arrears"
...
const dict: Record<Key, Partial<Record<Lang, string>>> = {
  ...
  settle_arrears: { ar: "تسوية المتأخرات (لا متابعة)", en: "Settle arrears (no follow-up)", ur: "بقایا طے کریں", zh: "结清欠款", hi: "बकाया निपटान", bn: "বকেয়া নিষ্পত্তি", fr: "Solder les arriérés", es: "Liquidar atrasos", tr: "Gecikmiş ödemeleri kapat" },
  carry_arrears: { ar: "ترحيل المتأخرات على المستأجر السابق", en: "Carry arrears to previous tenant", ur: "بقایا منتقل کریں", zh: "结转欠款", hi: "बकाया अग्रेषित", bn: "বকেয়া বহন", fr: "Reporter les arriérés", es: "Trasladar atrasos", tr: "Gecikmeleri devret" },
