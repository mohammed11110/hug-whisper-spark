...
const ARABIC_STACK = "'SF Arabic','Geeza Pro','Segoe UI',Tahoma,Arial,sans-serif"
...
export const SignupEmail = ({ confirmationUrl }: Props) => {
  return (
    <Html lang="ar" dir="rtl">
      ...
      <Body style={{ margin: 0, padding: 0, background: '#ECEAE2', WebkitTextSizeAdjust: '100%' }}>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td align="center" style={{ background: '#272B3A', padding: '34px 32px 30px' }}>
                          <table role="presentation" cellPadding={0} cellSpacing={0} align="center" style={{ borderCollapse: 'collapse' }}>
                            <tbody>
                              <tr>
                                <td align="center" style={{ width: '62px', height: '62px', background: '#B8924A', borderRadius: '16px', fontSize: '30px', lineHeight: '62px', textAlign: 'center' }}>🔑</td>
                              </tr>
                              <tr><td style={{ height: '14px', lineHeight: '14px', fontSize: 0 }}>&nbsp;</td></tr>
                              <tr>
                                <td align="center" style={{ fontFamily: ARABIC_STACK, color: '#FBFAF7', fontSize: '30px', fontWeight: 700, letterSpacing: '1px' }}>أملاكي</td>
                              </tr>
                              <tr>
                                <td align="center" style={{ fontFamily: LATIN_STACK, color: '#B8924A', fontSize: '11px', fontWeight: 600, letterSpacing: '5px', paddingTop: '5px' }}>A M L A K I</td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td style={{ padding: '40px 44px 8px', textAlign: 'right', direction: 'rtl' }}>
                          <p style={{ margin: '0 0 14px', fontFamily: LATIN_STACK, color: '#B8924A', fontSize: '12px', fontWeight: 700, letterSpacing: '2px' }}>
                            تأكيد الحساب · <span style={{ direction: 'ltr', unicodeBidi: 'isolate' }}>CONFIRM ACCOUNT</span>
                          </p>

                          <p dir="rtl" style={{ margin: '0 0 6px', fontFamily: ARABIC_STACK, color: '#272B3A', fontSize: '27px', fontWeight: 700, lineHeight: 1.4 }}>
                            أهلاً بك في أملاكي
                          </p>
                          <p style={{ margin: '0 0 22px', fontFamily: LATIN_STACK, color: '#8A8779', fontSize: '14px', fontWeight: 600, textAlign: 'left', direction: 'ltr', unicodeBidi: 'isolate' }}>
                            Welcome to Amlaki
                          </p>

                          <p style={{ margin: '0 0 8px', fontFamily: ARABIC_STACK, color: '#1A1C24', fontSize: '16px', lineHeight: 1.95 }}>
                            سجّلت للتو في أملاكي. اضغط الزر أدناه لتأكيد بريدك الإلكتروني وتفعيل حسابك.
                          </p>
                          <p style={{ margin: '0 0 30px', fontFamily: LATIN_STACK, color: '#8A8779', fontSize: '14px', lineHeight: 1.7, textAlign: 'left', direction: 'ltr', unicodeBidi: 'isolate' }}>
                              ...
                              <tr>
                                <td align="center" bgcolor="#B8924A" style={{ borderRadius: '12px' }}>
                                  <a href={confirmationUrl} target="_blank" rel="noreferrer"
                                    style={{ display: 'inline-block', fontFamily: ARABIC_STACK, color: '#FFFFFF', fontSize: '17px', fontWeight: 700, textDecoration: 'none', padding: '17px 52px', borderRadius: '12px' }}>
                                    تأكيد الحساب &nbsp;·&nbsp; <span style={{ direction: 'ltr', unicodeBidi: 'isolate' }}>Confirm account</span>
                                  </a>
                                </td>
                              </tr>
                          ...
                          <p style={{ margin: '0 0 4px', padding: '12px 14px', background: '#E9DFC8', borderRadius: '10px', fontFamily: LATIN_STACK, fontSize: '12px', lineHeight: 1.6, color: '#5d5a4f', wordBreak: 'break-all', direction: 'ltr', textAlign: 'left' }}>
                            {confirmationUrl}
                          </p>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td style={{ padding: '20px 44px 36px', textAlign: 'right', direction: 'rtl' }}>
                          ...
                          <p style={{ margin: 0, fontFamily: LATIN_STACK, color: '#A9A697', fontSize: '12px', lineHeight: 1.6, textAlign: 'left', direction: 'ltr', unicodeBidi: 'isolate' }}>
                      ...
                      <tr>
                        <td align="center" style={{ background: '#272B3A', padding: '24px 32px' }}>
                          <p dir="rtl" style={{ margin: '0 0 2px', fontFamily: ARABIC_STACK, color: '#B8924A', fontSize: '15px', fontWeight: 700 }}>فريق أملاكي</p>
                          <p dir="ltr" style={{ margin: '0 0 10px', fontFamily: LATIN_STACK, color: '#B8924A', fontSize: '12px', fontWeight: 600, letterSpacing: '1px' }}>Amlaki Team</p>
                          <p dir="rtl" style={{ margin: '0 0 2px', fontFamily: ARABIC_STACK, color: '#8A8779', fontSize: '13px' }}>إدارة عقاراتك بذكاء</p>
                          <p dir="ltr" style={{ margin: 0, fontFamily: LATIN_STACK, color: '#8A8779', fontSize: '12px' }}>Smart property management</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
